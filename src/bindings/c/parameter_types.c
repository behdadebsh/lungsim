...
extern void update_surfactant_c(const char *param_name, int *param_name_len, double *param_value);
extern void update_coupled_lymphatics_c(const char *param_name, int *param_name_len, double *param_value);

void update_surfactant(const char *param_name, double param_value)
{
  int param_name_len = strlen(param_name);
  update_surfactant_c(param_name, &param_name_len, &param_value);
}

void update_coupled_lymphatics(const char *param_name, double param_value)
{
  int param_name_len = strlen(param_name);
  update_coupled_lymphatics_c(param_name, &param_name_len, &param_value);
}
