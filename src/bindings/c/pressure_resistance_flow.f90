...
subroutine evaluate_prq_c(mesh_type,mesh_type_len,vessel_type,vessel_type_len,grav_dirn,grav_factor,bc_type,bc_type_len,inlet_bc, &
               outlet_bc,RMPA_flow,LMPA_flow,remodeling_grade) bind(C, name="evaluate_prq_c")
...
real(dp),intent(in) :: grav_factor,inlet_bc,outlet_bc,RMPA_flow, LMPA_flow
...
call so_evaluate_prq(mesh_type_f,vessel_type_f,grav_dirn,grav_factor,bc_type_f,inlet_bc,outlet_bc,RMPA_flow,LMPA_flow,remodeling_grade)
#else
call evaluate_prq(mesh_type_f,vessel_type_f,grav_dirn,grav_factor,bc_type_f,inlet_bc,outlet_bc,RMPA_flow,LMPA_flow,remodeling_grade)
#endif
